...
export const quizzData: { [key: string]: QuizzData[] } = {
  easy: [
    ...
    },
    {
      ...
      choose: ['Vứt rác bừa bãi.', 'Sử dụng tài nguyên một cách tiết kiệm.', 'Chặt phá cây cối.'],
      ans: 1,
    },
    {
      image: images.post1,
      ques: 'Cây xanh giúp ích gì cho môi trường?',
      choose: ['Cung cấp bóng mát.', 'Làm sạch không khí.', 'Cả hai câu trên đều đúng.'],
      ans: 2,
    },
    {
      image: images.post1,
    ...
    },
    {
      ...
      choose: ['Rác thải hữu cơ như vỏ trái cây, rau củ.', 'Rác thải nhựa.', 'Rác thải kim loại.'],
      ans: 0,
    },
    {
      image: images.post1,
  ...
  medium: [
    ...
    },
    {
      ...
      choose: ['Đi xe đạp thay vì đi ô tô.', 'Sử dụng bóng đèn sợi đốt.', 'Để đèn sáng cả ngày.'],
      ans: 0,
    },
    {
      image: images.post1,
  ...
  hard: [
    ...
    },
    {
      ...
      choose: ['Sản xuất, sử dụng, và tái chế.', 'Chỉ sản xuất và sử dụng.', 'Chỉ tái chế.'],
      ans: 0,
    },
    {
      image: images.post1,
